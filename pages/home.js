...
export default function Home() {
  ...
  useEffect(() => {
    fetch("https://backend-ontologia.azurewebsites.net/api/categorydiseases")
      ...
      <main className="mx-auto w-full min-h-screen">
        ...
        <div className="flex flex-row relative justify-center">
          <div className="relative w-3/5">
            <input
              className="w-full rounded-md px-3 border border-black h-10"
              type="text"
        ...
        <div className="flex flex-row justify-center py-6 space-x-10">
          <Link passHref href="/search">
            <a
              href="replace"
              className="rounded-md text-center hover:bg-bluebuscarhover w-48 h-9 bg-bluebuscar text-white font-medium"
            >
              Buscar
            </a>
          </Link>
          <Link passHref href="/assistedsearch">
            <a
              href="replace"
              className="rounded-md text-center hover:bg-bluepotatohover w-48 bg-bluepotato text-white font-medium"
            >
