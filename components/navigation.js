...
export default function Navigation() {
  ...
  return (
    <nav className="inset-x-0 sticky z-[4] top-0 shadow-md md:justify-center items-center celular:text-sm md:text-base ">
            ...
            <div className="flex flex-row justify-between z-[3]">
              <div className="flex flex-row md:space-x-10">
                <Link passHref href="/" className="flex items-center">
                  <Image
                    ...
                    width={40}
                    height={40}
                    className="celular:w-9 celular:h-9"
                    src="/Mark.svg"
                  />
                </Link>
                <div className="celular:hidden md:flex items-center md:space-x-10">
                  <div>
                    <Link passHref href="/assistedsearch">
                      <a
                        href="replace"
                        className=" hover:bg-gray-100 text-bluepotato px-3 py-1 rounded-md font-medium "
                      >
                        Busqueda guiada
                      </a>
                    </Link>
              ...
              <div className="md:hidden flex items-center">
                <button
                  ...
                  className="outline-none focus:bg-gray-300 rounded-md w-9 h-9"
                >
                  <FontAwesomeIcon
                ...
                <div className="celular:hidden md:flex items-center">
                  <div>
                    <Link passHref href="/assistedsearch">
                      <a
                        href="replace"
                        className=" hover:bg-gray-100 text-bluepotato px-3 py-1 rounded-md font-medium hidden"
                      >
                        Busqueda guiada
                      </a>
                    </Link>
              ...
              <div className="celular:hidden md:flex flex-row items-center celular:space-x-1 md:space-x-6">
                <div>
                  <Link passHref href="/login">
                    <a
                      href="replace"
                      className="flex justify-center items-center hover:bg-gray-100 px-3 h-8 rounded-md text-gray-500 font-medium"
                    >
                      Inicia sesión
                    </a>
                  </Link>
                ...
                <div>
                  <Link passHref href="/register">
                    <a
                      href="replace"
                      className="flex justify-center items-center text-white hover:bg-bluepotatohover h-8 rounded-md w-28 bg-bluepotato font-medium"
                    >
                      Regístrate
                    </a>
                  </Link>
      ...
      <div
        className={`md:hidden w-full bg-white rounded-lg shadow-lg text-base transition-all duration-300 ease-in fixed z-[3]  ${
          open ? "top-[67px]" : "top-[-300px]"
        }`}
      >
        {session || isAuth ? (
          <div>
            <div className="py-2 px-6 hover:bg-gray-200 duration-500">
              <Link passHref href="/suggestions">
                <a
                  href="replace"
                  className="text-bluepotato py-1 rounded-md font-medium"
                >
                  Sugerencias
                </a>
              </Link>
            ...
            <div className="flex flex-row pb-2 justify-between items-center py-2 px-6 hover:bg-gray-200 duration-500">
              <div className="flex flex-row space-x-3">
                {session ? (
                  ...
                  <FontAwesomeIcon
                    size="lg"
                    className="rounded-full w-[45px] h-[45px] m-auto"
                    icon={faUser}
                  />
                )}
            ...
            <div className="py-2 px-6 hover:bg-gray-200 duration-500">
              <Link passHref href="#">
                <a
                  href="replace"
                  className="text-gray-500 py-1 rounded-md font-medium"
                >
                  Perfil
                </a>
              </Link>
            ...
            <div
              onClick={() => signOutLocal()}
              className="py-3 px-6 hover:bg-gray-200 duration-500"
            >
              <Link passHref href="/login">
                <a
                  href="replace"
          ...
          <div>
            ...
            <div className="py-3 px-6 bg-bluepotato duration-500 text-center">
              <Link passHref href="/register">
                <a
                  href="replace"
                  className="text-white py-1 rounded-md font-medium"
                >
                  Regístrate
                </a>
              </Link>
